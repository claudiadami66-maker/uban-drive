...
.sc2{width:40px;height:40px;border-radius:50%;display:flex;align-items:center;
...
.scard{background:var(--card);border:1px solid var(--border);border-radius:16px;
...
.scard-icon{width:42px;height:42px;border-radius:12px;display:flex;
    align-items:center;justify-content:center;font-size:1.3rem;margin-bottom:12px;}
.scard-num{font-size:2rem;font-weight:900;color:var(--text);display:block;line-height:1;}
.scard-lbl{font-size:0.65rem;font-weight:700;text-transform:uppercase;
...
.ccard{background:var(--card);border:1px solid var(--border);border-radius:14px;
    padding:16px;margin-bottom:12px;transition:all 0.3s;position:relative;}
...
.rpt{font-size:0.88rem;font-weight:600;color:var(--text);}
.rarr{background:var(--grad);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;font-size:1.1rem;}
.chips{display:flex;flex-wrap:wrap;gap:6px;margin-bottom:8px;}
.chip{background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);
    border-radius:6px;padding:3px 9px;font-size:0.7rem;color:var(--text2);}
...
.si{font-size:3.5rem;margin-bottom:10px;animation:bounceIn 0.5s ease;}
...
def p_accueil():
    ...
    <div class="page">
    <div class="hero-card">
        <div style="font-size:0.78rem;color:var(--text2);margin-bottom:4px;">Bienvenue sur</div>
        <div style="font-size:1.8rem;font-weight:900;background:var(--grad);
            -webkit-background-clip:text;-webkit-text-fill-color:transparent;
            background-clip:text;margin-bottom:8px;">{li}UbanDrive</div>
        <div style="font-size:0.82rem;color:var(--text2);line-height:1.6;margin-bottom:16px;">
    ...
    feats=[
        ...
        ("rgba(245,158,11,0.2)","🔒","Courses sécurisées","Une course acceptée est verrouillée pour un seul chauffeur"),
    ]
...
def p_analyse():
        ...
        if res:
            ...
            <div class="card">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:10px;text-align:center;">
                    <div><div style="font-size:1.2rem;font-weight:800;color:#A78BFA;">{a:.1f}</div><div style="font-size:0.65rem;color:var(--text2);">Pente (a)</div></div>
                    <div><div style="font-size:1.2rem;font-weight:800;color:#60A5FA;">{b:.1f}</div><div style="font-size:0.65rem;color:var(--text2);">Ordonnée (b)</div></div>
                    <div><div style="font-size:1.2rem;font-weight:800;color:#10B981;">{r2:.3f}</div><div style="font-size:0.65rem;color:var(--text2);">R²</div></div>
                </div>
                <div style="margin-top:10px;padding:10px;background:var(--card2);border-radius:8px;font-size:0.78rem;color:var(--text);">
    ...
    with tabs[3]:
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
            <div style="padding:12px;background:rgba(124,58,237,0.1);border-radius:10px;border-left:3px solid #7C3AED;">
            ...
            <div style="padding:12px;background:rgba(59,130,246,0.1);border-radius:10px;border-left:3px solid #3B82F6;">
                ...
                <span style="font-size:0.75rem;color:var(--text2);">Moyenne, médiane, écart-type, Q1, Q3</span></div>
...
def c_accueil():
    ...
    <div class="page">
    <div class="hero-card">
        <div style="font-size:0.78rem;color:var(--text2);margin-bottom:4px;">Connecté en tant que</div>
        ...
        <div style="display:inline-flex;align-items:center;gap:8px;
            background:rgba(124,58,237,0.15);border:1px solid var(--border);
            border-radius:30px;padding:6px 14px;font-size:0.78rem;font-weight:600;color:var(--v2);">
            🆔 {ch['id']}
        </div>
    </div>
    <div class="sg">
...
def c_profil():
    ...
    <div class="card" style="text-align:center;margin-bottom:16px;">
        ...
        <div style="font-size:1.2rem;font-weight:800;background:var(--grad);
            -webkit-background-clip:text;-webkit-text-fill-color:transparent;
